...
urlpatterns = [
    ...
    path('register/verify-otp/', mentee.verify_register_otp, name='verify_register_otp'),
    ...
    path('register1/verify-otp/', mentor.verify_register_otp, name='verify_register1_otp'),
